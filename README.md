<h1 align="center">👋, I'm Rajesh Bhattacharjee</h1>
...
Analytics and Data Science:  `Microsoft Excel (PivotTables, Formulas, solver)` `Tableau BI` `Statistics` `Hadoop` `KNN` `PCA` <br/>
